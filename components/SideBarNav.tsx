...
const SideBarNav = () => {
  ...
  return (
    <div className="bg-black text-gray-500 p-3 text-xs lg:text-sm border-r border-gray-900 overflow-y-scroll scrollbar-hide h-screen sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex">
